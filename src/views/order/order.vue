<template>
  <div class="order">
    ...
    />
    <van-cell-group>
      <van-cell title="送达时间" :value="deliveryTime" is-link @click="showTimePickView" class="t-l">
        <template slot="label">
    ...
    <!-- 支付方式选择 -->
    <van-radio-group v-model="radio" class="t-l">
    ...
    <!-- 优惠券及积分满减 -->
    <van-cell-group style="margin-top: 0.6rem" class="t-l">
    ...
    <van-cell-group style="margin-top: 0.6rem" class="t-l">
      ...
      <van-cell title="积分" v-show="isShowPreferential">
        <div class="integralToMoney">-120</div>
      </van-cell>
    </van-cell-group>
